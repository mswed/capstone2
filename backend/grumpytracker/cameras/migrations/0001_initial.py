# Generated by Django 5.2.1 on 2025-05-18 22:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('anamorphic_squeeze', models.DecimalField(decimal_places=3, default=1.0, help_text='Lens anamorphic factor (2.0 is the most common but can me 1.8, 1.33, etc)', max_digits=3)),
                ('is_desqueezed', models.BooleanField(default=False, help_text='Has this footage already beed desqueezed in-camera?')),
                ('pixel_aspect', models.DecimalField(decimal_places=3, default=1.0, help_text='Pixel aspect', max_digits=4)),
                ...
                ('source', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='formats', to='cameras.source')),
            ],
            options={
                'unique_together': {('camera', 'image_format', 'image_aspect', 'is_anamorphic', 'codec', 'is_downsampled')},
            },
        ),
    ]
