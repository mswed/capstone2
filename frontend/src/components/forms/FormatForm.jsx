...
const FormatForm = ({
  ...
  const INITIAL_STATE = {
    ...
    anamorphicSqueeze: formatData?.anamorphicSqueeze
      ? formatData.anamorphicSqueeze
      : 1.0,
    ...
    rawRecordingAvailable: formatData?.rawRecordingAvailable
      ? formatData.rawRecordingAvailable
      : true,
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <Form.Group className="mb-3" controlId="imageFormat">
          ...
          <Form.Control
            ...
            name="imageFormat"
            onChange={handleChange}
            value={formatFormData.imageFormat}
          />
        </Form.Group>
        <Form.Group className="mb-3" controlId="imageAspect">
          <Form.Label>Image Aspect</Form.Label>
          <Form.Control
            placeholder="Image Aspect"
            name="imageAspect"
            onChange={handleChange}
            value={formatFormData.imageAspect}
          />
        </Form.Group>
        <Form.Group className="mb-3" controlId="formatName">
          ...
          <Form.Control
            ...
            name="formatName"
            onChange={handleChange}
            value={formatFormData.formatName}
          />
        </Form.Group>
        <Form.Group className="mb-3" controlId="imageWidth">
          ...
          <Form.Control
            ...
            name="imageWidth"
            onChange={handleChange}
            value={formatFormData.imageWidth}
          />
        </Form.Group>
        <Form.Group className="mb-3" controlId="imageHeight">
          ...
          <Form.Control
            ...
            name="imageHeight"
            onChange={handleChange}
            value={formatFormData.imageHeight}
          />
        </Form.Group>
        <Form.Group className="mb-3" controlId="sensorWidth">
          ...
          <Form.Control
            ...
            name="sensorWidth"
            onChange={handleChange}
            value={formatFormData.sensorWidth}
          />
        </Form.Group>
        <Form.Group className="mb-3" controlId="sensorHeight">
          ...
          <Form.Control
            ...
            name="sensorHeight"
            onChange={handleChange}
            value={formatFormData.sensorHeight}
          />
        </Form.Group>
        <Form.Check
          type="switch"
          ...
          label="Anamorphic?"
          onChange={handleChange}
          checked={formatFormData.isAnamorphic}
        />
        <Form.Group className="mb-3" controlId="anamorphicSqueeze">
          <Form.Label>Anamorphic Squeeze</Form.Label>
          <Form.Control
            placeholder="Anamorphic Squeeze"
            name="anamorphicSqueeze"
            onChange={handleChange}
            value={formatFormData.anamorphicSqueeze}
          />
        </Form.Group>
        <Form.Check
          type="switch"
          ...
          label="Desqueezed?"
          onChange={handleChange}
          checked={formatFormData.isDesqueezed}
        />
        <Form.Group className="mb-3" controlId="pixelAspect">
          ...
          <Form.Control
            ...
            name="pixelAspect"
            onChange={handleChange}
            value={formatFormData.pixelAspect}
          />
        </Form.Group>
        <Form.Check
          type="switch"
          ...
          label="Downsampled?"
          onChange={handleChange}
          checked={formatFormData.isDownsampled}
        />
        <Form.Check
          type="switch"
          className="mb-3"
          ...
          label="Upscaled?"
          onChange={handleChange}
          checked={formatFormData.isUpscaled}
        />
        ...
        <Form.Group className="mb-3" controlId="notes">
          ...
          <Form.Control
            ...
            name="notes"
            onChange={handleChange}
            value={formatFormData.notes}
          />
        </Form.Group>
        <Form.Group className="mb-3" controlId="notes">
          <Form.Label>Manufacturer Notes</Form.Label>
          <Form.Control
            placeholder="Manufacturer Notes"
            name="makeNotes"
            onChange={handleChange}
            value={formatFormData.makeNotes}
          />
        </Form.Group>
